package com.nu.assessmentplatform.constants;

public class UserConstants {
	public static final String ROLE = "role";
	public static final String EMPTY = " ";
	public static final String ID = "id";
	public static final String EMPTY_REQUEST = "Request is Empty/Null";
	public static final String NULOGIC_EMAIL = "@nulogic.io";
